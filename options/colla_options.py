...
class BaseOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--dataroot', type=str, default='./datasets/FSPI', help='data root')
        ...
        self.parser.add_argument('--disp_div_N', type=int, default=3, help=' display N per epoch')
        ...
        self.parser.add_argument('--name', type=str, default='collaGAN_WAFER', help='name of the experiment. It decides where to store samples and models')
        ...
        self.parser.add_argument('--nCh_C', type=int, default=8, help='# of ngf for Classifier')
        ...
        self.parser.add_argument('--ngf', type=int, default=16, help=' ngf')
